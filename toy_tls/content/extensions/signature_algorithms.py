...
class SignatureScheme(EnumUInt16WithData, ExtensibleEnum):
    ...
    ecdsa_sha256 = (0x0403, partial(ECDSASigner, hash=SHA256()), partial(ECDSAVerifier, hash=SHA256()))
    ...
    ecdsa_sha384 = (0x0503, partial(ECDSASigner, hash=SHA384()), partial(ECDSAVerifier, hash=SHA384()))
    ...
    ecdsa_sha512 = (0x0603, partial(ECDSASigner, hash=SHA512()), partial(ECDSAVerifier, hash=SHA512()))
